...
const initialData = [
  { id: 1, name: "Anie", email: "22A91A1234@aec.edu.in", branch: "CSE", testsTaken: 5, totalScore: 430 },
  { id: 2, name: "Balu", email: "22A91A1234@aec.edu.in", branch: "ECE", testsTaken: 4, totalScore: 375 },
  { id: 3, name: "Charan", email: "22A91A1234@aec.edu.in", branch: "EEE", testsTaken: 3, totalScore: 290 },
  { id: 4, name: "Divya", email: "22A91A1234@aec.edu.in", branch: "CSE", testsTaken: 5, totalScore: 455 },
  { id: 5, name: "Hanu", email: "22A91A1234@aec.edu.in", branch: "ECE", testsTaken: 4, totalScore: 390 },
  { id: 6, name: "Pavan", email: "22A91A1234@aec.edu.in", branch: "EEE", testsTaken: 2, totalScore: 160 },
];
      ...
      >
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-700">
            <thead>
              <tr>
                {["Name", "Email", "Branch", "Total Tests Taken", "Total Score", "View"].map((head) => (
                  <th
                    key={head}
              ...
              {filteredStudents.length > 0 ? (
                filteredStudents.map((student) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm text-gray-300">{student.branch}</td>
  ...
  <div className="fixed inset-0 z-50 bg-black bg-opacity-60 flex items-center justify-center">
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <p><strong>Branch:</strong> {alertStudent.branch}</p>
